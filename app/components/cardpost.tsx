...
const CardPost:React.FC<PostProps>= ({ id, title, content, author }) => {
    return (
        ...
        <div className="bg-yell w-full h-[40%] text-grayBlack shadow-xl shadow-primary p-2 rounded-bl-2xl">
            <h2 className="text-2xl font-bold text-center border-b mb-4">{title}</h2>
